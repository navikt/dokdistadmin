...
public class DokdistadminProperties {
	...
	public static class Database {
		 ...
		 * 	Optimizing UCP behaviour <a href="https://docs.oracle.com/database/121/JJUCP/optimize.htm#JJUCP8143">...</a>
		 * 	About Optimizing Real-World Performance with Static Conne<a href="ction">Pools
		 * 	https://docs.oracle.com/en/database/oracle/oracle-database/19/jjucp/optimizing-real-worl</a>d-performance.html
		 ...
		 * 	Max connections: 960
		 * Andre apper som bruker dokumentdistribusjon-<a href="db:
		 ">* 	Dokumentdistribusjon (https://github.com/navikt/dokumentdistribusjon/blob/master/dokdist-config/s</a>rc/main/resources/app-config.xml)
